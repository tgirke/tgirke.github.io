...
## Visualizing Spatial Assays in Anatomical Images
...
## Shiny App for _systemPipeR_ workflow

The [*systemPipeSiny*](https://bioconductor.org/packages/release/bioc/html/systemPipeShiny.html){:target="_blank"} 
systemPipeShiny (SPS) extends the widely used systemPipeR (SPR) workflow
...
<p align="center"><a https://bioconductor.org/packages/release/bioc/vignettes/systemPipeShiny/inst/doc/systemPipeShiny.html"><img src="/public/images/systemPipeShiny_vis_abstract.png" alt="image" style="width:500px;"/></a></p>
<font size="3"><b>Figure 3:</b> Overview of <i>spatialHeatmap</i> environment.</font>
