...
6. [Modeling Gene Expression Networks from RNA-Seq and ChIP-Seq Data](#geneexpressionanalysis)
7. [Software for Small Molecule Discovery and Chemical Genomics](#cheminformatics)
    1. [*ChemmineR* and ChemMine Tools](#chemminer)
    2. [*fmcsR* and *eiR*](#fmcsr)
8. [Protein Function Prediction](#proteinfct)
    1. [*sub-HMM*](#subhmm)
